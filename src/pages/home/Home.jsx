...
const Home = () => {
    ...
    <div className="home">
        ...
        <div className="features">
            <div className="container">
                <div className="item">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere impedit reiciendis eveniet recusandae porro quasi!
                    </p>
                    <div className="title">
                        <img src="/img/check.png" alt="" />
                        The best for every budget
        ...
        <div className="features purple-background">
            <div className="container">
                <div className="item">
